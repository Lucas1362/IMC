...
* **HTML** - Estruturação do conteudo
* **CSS** - Estilização do conteudo
* **JavaScript** - Utilizado para resolver os tramites de logica de calculo, validação de inputs e tratamento de erros.

  ## Funcionalidades
  * Calculo automatico do IMC
